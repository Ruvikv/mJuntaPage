    ...
    <div>
        <nav className="navbar p-3 bg-black">
            ...
            <div className="card d-flex flex-row justify-content-around align-items-center p-3">
              <a className="socialContainer containerOne" href="https://www.instagram.com/malajunta_sr/profilecard/?igsh=MTduN3VnMHk2NjRpdA==">
              ...
              <a className="socialContainer containerFour" href="https://wa.me/message/LGC73ELZ7K3RK1">
            ...
            <div className="offcanvas offcanvas-start " data-bs-backdrop="static" tabindex="-1" id="staticBackdrop" aria-labelledby="staticBackdropLabel">
                <div className="offcanvas-header bg-dark ">
                    <h5 className="offcanvas-title text-light" id="staticBackdropLabel">Mala Junta</h5>
                ...
                <div className="offcanvas-body">
                  ...
                  <button className="customMenuButton bo">
                    <span className='h6'>Mi Perfil</span>
                  </button>                  
                  </Link>
                  <hr style={{ border: "1px solid gray" }} />
                  <Link to="/bebidas">
